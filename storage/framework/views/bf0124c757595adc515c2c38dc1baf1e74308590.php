...
<div class="m-content">
	<div class="row">
        ...
        <div class="m-portlet m-portlet--tab">
          ...
          <form class="m-form m-form--fit m-form--label-align-right"  method="post" action="<?php echo e(url('areas')); ?>">
          <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?> " name="area_name" id="categoryName" autocomplete="off" placeholder="Category Name Input" value="<?php echo e(old('area_name')); ?>" required>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout/base11', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/hospex2020/hospex_admin/resources/views/area/create.blade.php ENDPATH**/ ?>