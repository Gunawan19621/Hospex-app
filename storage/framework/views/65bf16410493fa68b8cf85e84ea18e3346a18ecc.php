...
<html lang="en">
	...
	<head>
		...
		<link href="<?php echo e(url('assets11/vendors/custom/fullcalendar/fullcalendar.bundle.css')); ?>" rel="stylesheet" type="text/css" />

		<!--RTL version:<link href="assets/vendors/custom/fullcalendar/fullcalendar.bundle.rtl.css" rel="stylesheet" type="text/css" />-->
        <link href="<?php echo e(url('assets11/vendors/custom/datatables/datatables.bundle.css')); ?>" rel="stylesheet" type="text/css" />
	...
	<body class="m-content--skin- m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-light m-aside--offcanvas-default">
							...
							<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover" m-menu-link-redirect="1"><a href="javascript:;" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon flaticon-graphic-1"></i><span
								...
								<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item " aria-haspopup="true" m-menu-link-redirect="1"><a href="<?php echo e(url('/areas')); ?>" class="m-menu__link "><span class="m-menu__link-text">Areas</span></a></li>
										<li class="m-menu__item " aria-haspopup="true" m-menu-link-redirect="1"><a href="<?php echo e(url('/stands')); ?>" class="m-menu__link "><span class="m-menu__link-text">Stands</span></a></li>
									</ul>
								</div>
							</li>
		...
		<!--begin::Page Vendors -->
        <script src="<?php echo e(url('assets11/vendors/custom/fullcalendar/fullcalendar.bundle.js')); ?>" type="text/javascript"></script>
        <script src="<?php echo e(url('assets11/vendors/custom/datatables/datatables.bundle.js')); ?>" type="text/javascript"></script>
        <?php echo $__env->yieldContent('require'); ?>
		<!--end::Page Vendors -->

		<!--begin::Page Scripts -->
		<script src="<?php echo e(url('assets11/app/js/dashboard.js')); ?>" type="text/javascript"></script>
		<script src="<?php echo e(url('assets11/demo/demo11/custom/crud/forms/widgets/select2.js')); ?>" type="text/javascript"></script>

		<!--end::Page Scripts -->
	</body>

	<!-- end::Body -->
</html><?php /**PATH E:\xampp\htdocs\hospex2020\resources\views/layout/base11.blade.php ENDPATH**/ ?>