...
<div class="m-content">
	<div class="row">
        ...
        <form class="m-form m-form--fit m-form--label-align-right"  method="post" action="<?php echo e(url('stands').'/'.$stand->id); ?>">
...
unset($__errorArgs, $__bag); ?> " name="stand_name" id="standName" placeholder="Stand Name Input" value="<?php echo e($stand->stand_name); ?>" required>
...
unset($__errorArgs, $__bag); ?> " name="area_id" id="areaID" value="<?php echo e($stand->area_id); ?>" required>
...
unset($__errorArgs, $__bag); ?> " name="exhibitor_id" id="exhibitorID" value="<?php echo e($stand->exhibitor_id); ?>" required>
...
<?php $__env->startSection('require'); ?>
 ...
 <?php $__env->stopSection(); ?>
<?php echo $__env->make('layout/base11', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/hospex2020/hospex_admin/resources/views/stand/edit.blade.php ENDPATH**/ ?>