...
<div class="m-content">
	<div class="row">
        ...
        <div class="m-portlet m-portlet--tab">
          ...
          <form class="m-form m-form--fit m-form--label-align-right"  method="post" action="<?php echo e(url('stands')); ?>">
          <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?> " name="stand_name" id="standName" placeholder="Stand Name Input" value="<?php echo e(old('stand_name')); ?>" required>
...
unset($__errorArgs, $__bag); ?> " name="area_id" id="areaID" value="<?php echo e(old('area_id')); ?>" required>
                      <option value="" > Area </option>
                      <?php $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value=" <?php echo e($area->id); ?> " > <?php echo e($area->area_name.' ('.$area->event->event_title.')'); ?> </option>
...
unset($__errorArgs, $__bag); ?> " name="exhibitor_id" id="exhibitorID" value="<?php echo e(old('exhibitor_id')); ?>" required>
                  </select>
...
unset($__errorArgs, $__bag); ?> " name="area_name" id="categoryName" autocomplete="off" placeholder="Area Name Input" value="<?php echo e(old('area_name')); ?>" required>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script type="text/javascript">
        $('#exhibitorID').select2({
            ...
            ajax: {
                url: '<?php echo e(route('exhibitor_stand.ajax.select2')); ?>',
                dataType: 'json',
                delay: 250,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout/base11', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/hospex2020/hospex_admin/resources/views/stand/create.blade.php ENDPATH**/ ?>