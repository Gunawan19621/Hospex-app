...
class ImageController extends BaseController
{
    ...
    {
        // $company = Company::whereId($request->exhibitor)->first();
        ...
        if($request->hasFile('image')) {
            ...
            $file = $request->file('image');//$_FILES['image']['tmp_name']; 
        ...
        if ($request->hasFile('image')) {
            ...
            //  })->save($destination_path . '/' . $image);
            // $img = $this->resize_image($request->file('image'), 200, 200);
