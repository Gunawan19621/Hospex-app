    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="m-portlet  m-portlet--full-height ">
            <div class="m-portlet__head">
                ...
                <a href="/eventschedules/create/<?php echo e($event->id); ?>" class="btn btn-primary my-3">Add</a>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="m-portlet  m-portlet--full-height ">
                                    <div class="m-portlet__head">
                                        ...
                                        <div class="m-portlet__head-tools">
                                        <a href="/eventrundown/create/<?php echo e($schedule->id); ?>" class="btn btn-primary my-3">Add Task</a>
                                        </div>
                                    </div>
                                    <div class="m-portlet__body">
														...
														<div class="m-timeline-1__item-body">
															<div class="m-list-pics">
                                                                <?php $__currentLoopData = $task->performers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $performer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    																<a href="../../#"><img src="<?php echo e(url('assets11/app/media/img/users/100_13.jpg')); ?>" title=""><?php echo e($performer->name); ?></a><br>
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layout/base11', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/hospex2020-master/hospex_admin/resources/views/event_schedule/schedules.blade.php ENDPATH**/ ?>