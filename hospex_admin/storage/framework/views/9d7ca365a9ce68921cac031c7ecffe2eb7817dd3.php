...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="m-login__signup">
                        ...
                        <form id="form-sign-up" class="m-login__form m-form" method="POST" action="<?php echo e(route('register')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="form-group m-form__group">
                    ...
                    <div class="m-login__forget-password">
                        ...
                        <form class="m-login__form m-form" method="POST" action="<?php echo e(route('password.email')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="form-group m-form__group">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/hospex2020-master/hospex_admin/resources/views/auth/login.blade.php ENDPATH**/ ?>