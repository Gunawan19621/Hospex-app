...
<div class="m-content">
	<div class="row">
        ...
        <form class="m-form m-form--fit m-form--label-align-right"  method="post" action="/areas/{{$area->id}}">
            @method('patch')
            @csrf
              <div class="m-portlet__body">
                  <div class="form-group m-form__group">
                    <label for="eventitel">Area Name</label>
                    <input type="text" class="form-control @error('area_name') is-invalid @enderror " name="area_name" id="categoryName" autocomplete="off" placeholder="Category Name Input" value="{{ $area->area_name }}">
