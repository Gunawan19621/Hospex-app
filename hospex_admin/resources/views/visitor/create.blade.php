          ...
          @csrf
              <div class="m-portlet__body">
                <div class="form-group m-form__group">
                    ...
                    <input type="text" autocomplete="off" class="form-control @error('visitor_name') is-invalid @enderror " name="visitor_name" id="visitorName" placeholder="Stand Name Input" value="{{ old('visitor_name') }}">
                    @error('visitor_name') <div class="invalid-feedback"> {{ $message }} </div> @enderror
                </div>
                <div class="form-group m-form__group">
                    <label for="companyName">Visitor Email</label>
                    <input type="text" autocomplete="off" class="form-control @error('visitor_email') is-invalid @enderror " name="visitor_email" id="visitorEmail" placeholder="Stand Name Input" value="{{ old('visitor_email') }}">
