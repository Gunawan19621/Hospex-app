...
<div class="m-content">
	<div class="row">
        ...
        <div class="m-portlet m-portlet--tab">
          <div class="m-portlet__head">
              <div class="m-portlet__head-caption">
                  ...
                  <h3 class="m-portlet__head-text">
                      Form Add Schedule Match Request
                  </h3>
                  </div>
              </div>
          ...
          <form class="m-form m-form--fit m-form--label-align-right"  method="post" action="{{ url('available-schedule') }}">
          @csrf
              <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group">
                    ...
                    <input type="text" class="form-control @error('date') is-invalid @enderror date-schedule" name="date" autocomplete="off" placeholder="Available Schedule Date" value="{{ old('date') }}" readonly required>
                    @error('date') <div class="invalid-feedback"> {{ $message }} </div> @enderror
                </div>
                <div class="form-group m-form__group">
                  <label for="time">Time</label>
                    <div class="input-group-append">
                    <input type="text" autocomplete="off" class="form-control input-time @error('time') is-invalid @enderror " name="time" id="m_timepicker_1_validate" placeholder="Available Schedule Time" value="{{ old('time') }}" readonly required>
